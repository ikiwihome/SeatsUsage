...
const guideContent: Record<GuideTab, { title: string; description: string; sections: readonly GuideSection[] }> = {
  'Claude Code': {
    ...
    description: 'Windows 与 Linux 都可以直接配置环境变量，下面给出可直接复制的值。\n默认使用 Auto 模式自动选择模型，也可按需调整各层级模型。',
    sections: [
      {
        ...
        code: [
          ...
          '$env:ANTHROPIC_DEFAULT_OPUS_MODEL="z-ai/glm-latest"',
      ...
      },
      {
        ...
        code: [
          ...
          'export ANTHROPIC_DEFAULT_OPUS_MODEL="z-ai/glm-latest"',
